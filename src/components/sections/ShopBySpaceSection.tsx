...
export default function ShopBySpaceSection() {
  return (
    <section id="khong-gian" className="py-24 md:py-36 bg-[#F5F1EA] border-b border-[#D5CDBE]">
              ...
              >
                ...
                <div className="p-6 md:p-8 flex flex-col justify-between flex-1">
                  <div>
                    ...
                    <h3 className="font-serif text-2xl font-normal text-[#1C1B19] group-hover:text-[#B85C38] transition-colors mb-3">
                      {space.name}
                    </h3>
                    <p className="text-xs md:text-sm text-[#1C1B19]/70 line-clamp-2 leading-relaxed font-light mb-6">
                      {space.tagline}
                    </p>
                  </div>
