...
const MATERIALS: MaterialCardData[] = [
  {
    ...
    spanClass: 'md:col-span-8 md:row-span-2 min-h-[260px] sm:min-h-[340px] md:min-h-[420px]',
  },
  {
    title: 'Stone',
    ...
    spanClass: 'md:col-span-4 min-h-[220px] sm:min-h-[260px] md:min-h-[300px]',
  },
  {
    title: 'Cement',
  ...
  },
  {
    ...
    spanClass: 'md:col-span-4 min-h-[220px] sm:min-h-[260px] md:min-h-[320px]',
  },
  {
    title: 'Wood',
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-6">
          {MATERIALS.map((mat) => (
            <Link
              ...
              className={`group relative overflow-hidden bg-[#1C1B19] ${mat.spanClass} flex flex-col justify-end p-5 sm:p-6 md:p-8 transition-transform duration-300`}
            >
              {/* Background Image */}
              <Image
                src={mat.image}
              ...
              <div className="relative z-10 text-[#F5F1EA]">
                <div className="flex items-center justify-between text-[10px] sm:text-[11px] font-mono tracking-widest text-[#D7CEBE] mb-2 uppercase">
                ...
                <h3 className="font-serif text-xl sm:text-2xl md:text-3xl font-normal text-white group-hover:translate-x-1 transition-transform duration-300">
                  {mat.title} <span className="font-sans text-xs sm:text-sm font-light text-[#D7CEBE] ml-1.5 sm:ml-2">({mat.vietnameseName})</span>
                </h3>
                <p className="text-[11px] sm:text-xs text-[#F5F1EA]/80 mt-1.5 sm:mt-2 font-light line-clamp-2 max-w-md">
                  {mat.description}
                </p>
              </div>
            </Link>
