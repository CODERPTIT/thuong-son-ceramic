      ...
      <div className="max-w-[1440px] mx-auto px-5 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-8 relative aspect-[16/10] sm:aspect-[16/9] bg-[#EBE5DA] overflow-hidden group">
            ...
            <div className="absolute top-6 left-6 bg-[#1C1B19]/85 text-[#F5F1EA] text-[10px] font-mono px-3 py-1 uppercase tracking-widest">
              Bộ Sưu Tập Tiêu Biểu · 2026
            </div>
            <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between text-[#F5F1EA] text-xs font-mono">
              <span className="bg-[#1C1B19]/70 backdrop-blur-sm px-3 py-1">
          ...
          <div className="lg:col-span-4 flex flex-col justify-center space-y-6">
            <div>
              ...
              <h2 className="font-serif text-3xl sm:text-4xl font-light text-[#1C1B19] leading-tight">
                {collection.name}
              </h2>
            </div>
              ...
              <div className="grid grid-cols-3 gap-2">
                {collectionProducts.map((p) => (
                  <Link
                    ...
                    className="p-2 bg-white border border-[#D5CDBE] hover:border-[#B85C38] transition-colors group block"
                  >
                    <div className="relative aspect-square mb-1.5 overflow-hidden bg-[#FAF8F4]">
                      <Image
                    ...
                    <span className="text-[10px] font-mono text-[#1C1B19] block truncate font-medium">
                      {p.code}
                    </span>
                    <span className="text-[9px] text-[#8B7C66] block truncate">
                      {p.surface}
                    </span>
                  </Link>
                ))}
